...
const currenMonthDayYear = date.toLocaleDateString('en-US', { month: 'short', day: '2-digit', year: 'numeric' }).replace(',', '');
...
const taskName = completedBtn.parentElement.parentElement.children[1].innerText 
